...
IF(USE_OPENNI2)
	...
	MESSAGE("OPENNI_LIBRARY_PATH ${OPENNI_LIBRARY_PATH}")
	FILE(GLOB OPENNI2_DRIVERS_FILES ${OPENNI_LIBRARY_PATH}/OpenNI.ini ${OPENNI_LIBRARY_PATH}/OpenNI2/Drivers/*.ini)
	FOREACH(OPENNI2_DRIVERS_FILE ${OPENNI2_DRIVERS_FILES})
		MESSAGE("OPENNI2_DRIVERS_FILE ${OPENNI2_DRIVERS_FILE}")
	ENDFOREACH()
	FILE(GLOB OPENNI2_DRIVERS_LIBS ${OPENNI_LIBRARY_PATH}/OpenNI2/Drivers/*.dylib )
	FOREACH(OPENNI2_DRIVERS_LIB ${OPENNI2_DRIVERS_LIBS})
		GET_FILENAME_COMPONENT(OPENNI2_DRIVERS_LIB_NAME ${OPENNI2_DRIVERS_LIB} NAME)
		MESSAGE("OPENNI2_DRIVERS_LIB ${OPENNI2_DRIVERS_LIB} ${OPENNI2_DRIVERS_LIB_NAME}")
		INSTALL(PROGRAMS "${OPENNI2_DRIVERS_LIB}" DESTINATION ${EXECUTABLE_NAME}.app/Contents/MacOS/OpenNI2/Drivers COMPONENT ${EXECUTABLE_NAME})
		LIST(APPEND EXTRA_APPS "${CMAKE_INSTALL_PREFIX}/${EXECUTABLE_NAME}.app/Contents/MacOS/OpenNI2/Drivers/${OPENNI2_DRIVERS_LIB_NAME}")
	ENDFOREACH()
	IF(NITE_FOUND)
		INSTALL(DIRECTORY "${OPENNI_LIBRARY_PATH}/NiTE2" DESTINATION ${EXECUTABLE_NAME}.app/Contents/Resources COMPONENT ${EXECUTABLE_NAME})
	ENDIF()
ENDIF()
